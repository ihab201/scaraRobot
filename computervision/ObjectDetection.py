...
import numpy as np 
from Detector import * # getting everything from the detectror class

#video capture from the camera
cap = cv2.VideoCapture(0)

# Wait a certain number of seconds for the camera to setup
time.sleep(0.1)
...
# 36.0 cm across the width of the field of view of the camera.
...
# Define the displacement vector from frame 0 to frame c (frame c is for the camera)
