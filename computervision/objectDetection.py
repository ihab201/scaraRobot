...
with open(r'Camera Calibration Algorithms/2. camera_calibration_tool-master/robot_position.yaml') as file:
...
#Reading Camera Matrices and Distortion Coefficients from YAML File
...
Ki=0.1
Kd=0.05
pid = PID(Kp, Ki, Kd, setpoint=1) #init PID object
...
def undistortImage(img): #Function to undistort a given image. Function inputs: image, camera matrix and distortion coefficients
    ...
    # undistort
    undist_image = cv.undistort(img, mtx, dist, None, newcameramtx)
